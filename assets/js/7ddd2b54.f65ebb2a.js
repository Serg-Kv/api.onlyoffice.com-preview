"use strict";(self.webpackChunkapi_onlyoffice_com=self.webpackChunkapi_onlyoffice_com||[]).push([["421034"],{956358(e,t,n){n.r(t),n.d(t,{metadata:()=>o,default:()=>u,frontMatter:()=>r,contentTitle:()=>i,toc:()=>d,assets:()=>c});var o=JSON.parse('{"id":"docs/docs-api/samples/automation-api/filling-out-the-form","title":"Filling out the form","description":"Fill form fields from an external UI with bidirectional sync.","source":"@site/site/docs/docs-api/samples/automation-api/filling-out-the-form.md","sourceDirName":"docs/docs-api/samples/automation-api","slug":"/docs/docs-api/samples/automation-api/filling-out-the-form","permalink":"/api.onlyoffice.com-preview/docs/docs-api/samples/automation-api/filling-out-the-form","draft":false,"unlisted":false,"editUrl":"https://github.com/ONLYOFFICE/api.onlyoffice.com/tree/master/site/docs/docs-api/samples/automation-api/filling-out-the-form.md","tags":[{"inline":true,"label":"Docs","permalink":"/api.onlyoffice.com-preview/tags/docs"},{"inline":true,"label":"Integration","permalink":"/api.onlyoffice.com-preview/tags/integration"},{"inline":true,"label":"External access","permalink":"/api.onlyoffice.com-preview/tags/external-access"},{"inline":true,"label":"Automation API","permalink":"/api.onlyoffice.com-preview/tags/automation-api"}],"version":"current","sidebarPosition":-1,"frontMatter":{"sidebar_position":-1,"hide_table_of_contents":true,"description":"Fill form fields from an external UI with bidirectional sync.","tags":["Docs","Integration","External access","Automation API"]},"sidebar":"docsDocs","previous":{"title":"Working with review changes","permalink":"/api.onlyoffice.com-preview/docs/docs-api/samples/automation-api/working-with-review-changes"},"next":{"title":"Working with content controls","permalink":"/api.onlyoffice.com-preview/docs/docs-api/samples/automation-api/working-with-content-controls"}}'),a=n(474848),l=n(28453),s=n(339332);let r={sidebar_position:-1,hide_table_of_contents:!0,description:"Fill form fields from an external UI with bidirectional sync.",tags:["Docs","Integration","External access","Automation API"]},i="Filling out the form",c={},d=[{value:"How it works",id:"how-it-works",level:2}];function m(e){let t={a:"a",admonition:"admonition",code:"code",h1:"h1",h2:"h2",header:"header",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",...(0,l.R)(),...e.components};return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(t.header,{children:(0,a.jsx)(t.h1,{id:"filling-out-the-form",children:"Filling out the form"})}),"\n",(0,a.jsx)(t.p,{children:"Use the Automation API to fill form fields from an external UI \u2014 select a person from the dropdown and all fields update automatically in both the editor and the custom interface."}),"\n",(0,a.jsx)(t.admonition,{type:"info",children:(0,a.jsxs)(t.p,{children:["The document opens as a fillable PDF form. Your code calls ",(0,a.jsx)(t.code,{children:"connector.executeMethod()"})," to read and write form values. Changes sync bidirectionally in real time."]})}),"\n",(0,a.jsx)(s.DW,{}),"\n",(0,a.jsx)(t.h2,{id:"how-it-works",children:"How it works"}),"\n",(0,a.jsxs)(t.ol,{children:["\n",(0,a.jsxs)(t.li,{children:["\n",(0,a.jsxs)(t.p,{children:["When the user opens a form document, the ",(0,a.jsx)(t.a,{href:"/api.onlyoffice.com-preview/docs/plugin-and-macros/interacting-with-editors/document-api/Methods/GetAllContentControls",children:"GetAllContentControls"})," method is executed to collect all the content controls from the document. After that, the ",(0,a.jsx)(t.a,{href:"/api.onlyoffice.com-preview/docs/plugin-and-macros/interacting-with-editors/form-api/Methods/GetFormValue",children:"GetFormValue"})," method is executed to get the content controls values and display them in the custom interface:"]}),"\n",(0,a.jsx)(t.pre,{children:(0,a.jsx)(t.code,{className:"language-ts",children:'let contentControls = [];\r\n\r\nconst onDocumentReady = () => {\r\n  window.connector = docEditor.createConnector();\r\n\r\n  connector.executeMethod("GetAllContentControls", null, (data) => {\r\n    for (let i = 0; i < data.length; i++) {\r\n      connector.executeMethod("GetFormValue", [data[i]["InternalId"]], (value) => {\r\n        data[i].Value = value || "";\r\n        if (i === data.length - 1) {\r\n          contentControls = data;\r\n        }\r\n      });\r\n    }\r\n  });\r\n};\n'})}),"\n"]}),"\n",(0,a.jsxs)(t.li,{children:["\n",(0,a.jsxs)(t.p,{children:["When the user chooses a username from the list, the ",(0,a.jsx)(t.a,{href:"/api.onlyoffice.com-preview/docs/plugin-and-macros/interacting-with-editors/form-api/Methods/GetFormsByTag",children:"GetFormsByTag"})," method is executed to collect all the forms by their tags and sets the corresponding values to them with the ",(0,a.jsx)(t.a,{href:"/api.onlyoffice.com-preview/docs/plugin-and-macros/interacting-with-editors/form-api/Methods/SetFormValue",children:"SetFormValue"})," method:"]}),"\n",(0,a.jsx)(t.pre,{children:(0,a.jsx)(t.code,{className:"language-ts",children:'document.getElementById("persons").addEventListener("change", function () {\r\n  const person = persons.find((p) => p["PostalCode"] === this.value);\r\n  for (const key in person) {\r\n    const value = person[key];\r\n    setFormValue(key, value);\r\n  }\r\n});\r\n\r\nconst setFormValue = (tag, value) => {\r\n  connector.executeMethod("GetFormsByTag", [tag], (forms) => {\r\n    connector.executeMethod("SetFormValue", [forms[0]["InternalId"], value], null);\r\n  });\r\n};\n'})}),"\n"]}),"\n",(0,a.jsxs)(t.li,{children:["\n",(0,a.jsxs)(t.p,{children:["When the user edits a form value, the ",(0,a.jsx)(t.a,{href:"/api.onlyoffice.com-preview/docs/plugin-and-macros/interacting-with-editors/document-api/Events/onChangeContentControl",children:"onChangeContentControl"})," event is fired and after that, the ",(0,a.jsx)(t.a,{href:"/api.onlyoffice.com-preview/docs/plugin-and-macros/interacting-with-editors/form-api/Methods/GetFormValue",children:"GetFormValue"})," method is executed to get an updated form value and display it in the custom interface:"]}),"\n",(0,a.jsx)(t.pre,{children:(0,a.jsx)(t.code,{className:"language-ts",children:'const onDocumentReady = () => {\r\n  connector.attachEvent("onChangeContentControl", (e) => {\r\n    connector.executeMethod("GetFormValue", [e["InternalId"]], (value) => {\r\n      const element = document.getElementById(e["InternalId"]);\r\n      if (element.classList.contains("content-control-radio")) {\r\n        element.checked = value;\r\n      } else {\r\n        element.value = value || "";\r\n      }\r\n    });\r\n  });\r\n};\n'})}),"\n"]}),"\n"]}),"\n",(0,a.jsxs)(t.admonition,{type:"note",children:[(0,a.jsxs)(t.p,{children:["Please note that the connector is available only for ",(0,a.jsx)(t.strong,{children:"ONLYOFFICE Docs Developer"}),"."]}),(0,a.jsxs)(t.p,{children:["The connector is an additional feature not included by default in the ONLYOFFICE Docs Developer and is available at an extra cost. Please contact our sales team at ",(0,a.jsx)(t.a,{href:"mailto:sales@onlyoffice.com",children:"sales@onlyoffice.com"})," to request a quote."]})]})]})}function u(e={}){let{wrapper:t}={...(0,l.R)(),...e.components};return t?(0,a.jsx)(t,{...e,children:(0,a.jsx)(m,{...e})}):m(e)}},345942(e,t,n){n.d(t,{A:()=>d});var o=n(474848),a=n(296540),l=n(610898),s=n(983941);async function r(e,t){if(!t)return null;let n=e=>btoa(e).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),o=n(JSON.stringify({typ:"JWT",alg:"HS256"})),a=n(JSON.stringify(e)),l=new TextEncoder,s={name:"HMAC",hash:"SHA-256"},r=await crypto.subtle.importKey("raw",l.encode(t),s,!1,["sign","verify"]),i=l.encode(`${o}.${a}`),c=n(String.fromCharCode(...new Uint8Array(await crypto.subtle.sign(s.name,r,i))));return`${o}.${a}.${c}`}let i="editorScript",c=async(e,t,n,o,a,l,s,c,d=!1,m=!1)=>{let u=document.createElement("script");u.id=i,u.type="text/javascript";let p=((e,t,n,o=!1,a=!1)=>({fileType:e,key:`doc-${Date.now()}`,title:n||`Example Document.${e}`,url:t||`https://static.onlyoffice.com/assets/docs/samples/${((e,t=!1,n=!1)=>t?n?"demo-invoice":"demo":"pdf"!==e||n?"new":"blank")(e,o,a)}.${e}`}))(t,a,s?.document?.title,d,m);s?.editorConfig?.customization?.logo?.image&&(s.editorConfig.customization.logo.image=new URL("/assets/images/try-docs/example-logo.png",window.location.origin).href),s?.editorConfig?.customization?.customer?.logo&&(s.editorConfig.customization.customer.logo=new URL("/assets/images/try-docs/example-logo-big.png",window.location.origin).href);let h=function e(t,...n){let o={...t};for(let t of n)for(let n in t){let a=o[n],l=t[n];l&&"object"==typeof l&&!Array.isArray(l)?o[n]=e(a&&"object"==typeof a?a:{},l):o[n]=l}return o}(s||{},{document:p,documentType:(e=>{switch(e){case"xlsx":case"xls":case"ods":case"csv":return"cell";case"pptx":case"ppsx":case"ppt":case"odp":return"slide";case"pdf":return"pdf";default:return"word"}})(t),editorConfig:{callbackUrl:"",customization:{anonymous:{request:!1},uiTheme:"dark"===o?"default-dark":"default-light",features:{featuresTips:!1},zoom:l}}}),C=await r(h,e);u.innerHTML=`
    if (window.docEditor) {
